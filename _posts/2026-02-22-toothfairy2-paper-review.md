...
FDI notation[^1] 기반으로 개별 치아를 다 따로 annotate한다는 부분이 흥미로웠다. 치아 32개(사랑니 4개도 포함이다 ㅋㅋ)가 각각 별도 class로 잡히는 구조다.
...
![jagged artifact issue](/imgs/5.png)
...
[^1]: World Dental Numbering System
